...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(5)(module), __webpack_require__(6)))
...
document.addEventListener("DOMContentLoaded", function (e) {
	;(function () {
		var animateElements = document.querySelectorAll(".advantage, .programm-item, .how-item");

		if (!animateElements.length) return;

		for (var _iterator = animateElements, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
			var _ref;
		...
		var animateElements = document.querySelectorAll(".advantage, .programm-item, .person, .for, .how-item");

		if (!animateElements.length) return;

		for (var _iterator2 = animateElements, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
			var _ref2;
			...
			_TweenMax.TweenLite.set(element, {
				autoAlpha: 0
			});
		}var forElements = function forElements(_) {
			var i = 0;
			for (var _iterator3 = animateElements, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
				var _ref3;
...
var showElement = function showElement(element, pos) {
	_TweenMax.TweenLite.to(element, .4, {
		autoAlpha: 1,
		delay: pos * .2
	});
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweenLite_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__TweenMaxBase_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CSSPlugin_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AttrPlugin_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RoundPropsPlugin_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__DirectionalRotationPlugin_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__TimelineLite_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__TimelineMax_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__BezierPlugin_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__EasePack_js__ = __webpack_require__(14);
